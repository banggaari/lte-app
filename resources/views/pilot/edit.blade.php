...
@section('content')
    ...
    <x-adminlte-card theme="lime" theme-mode="outline">
        <form action="{{ route('pilots.update', $inputs['id']) }}" method="POST">
            @csrf
            @method('PUT')
            <label>User *</label>
            <x-adminlte-input name="username" value="{{ $inputs['username'] }}" class="form-control" id=username placeholder="User" readonly="readonly">
            ...
            <x-adminlte-input name="satuankerja" class="form-control" value="{{ $inputs['satuankerja'] }}" id=satuankerja placeholder="Satuan Kerja" readonly="readonly">
                <x-slot name="prependSlot">
                    <div class="input-group-text">
            ...
            <x-adminlte-input name="no_license" class="form-control" value="{{ $inputs['no_license'] }}" id=no_license placeholder="No License">
            </x-adminlte-input>
            <label>Masa Berlaku *</label>
            <x-adminlte-input-date class="form-control" value="{{ $inputs['masa_berlaku'] }}" name="masa_berlaku" id=masa_berlaku :config="$configDate" placeholder="Choose a date...">
                <x-slot name="appendSlot">
            ...
            <x-adminlte-input name="no_kontak" class="form-control" value="{{ $inputs['no_kontak']}}" id=no_kontak placeholder="No Kontak">
                <x-slot name="prependSlot">
                    <div class="input-group-text">
                        <i>+62</i>
                    </div>
            ...
            <x-adminlte-textarea name="riwayat_training" value="{{ $inputs['riwayat_training'] }}" class="form-control" id=riwayat_training
            ...
            <x-adminlte-input name="idusername" class="form-control" value="{{ $inputs['idusername'] }}" id=idusername type="hidden" />
            <x-adminlte-input name="idSatuanKerja" class="form-control" value="{{ $inputs['idSatuanKerja'] }}" id=idSatuanKerja type="hidden" />
    </x-adminlte-card>
    </form>
    {{-- Modal User --}}
